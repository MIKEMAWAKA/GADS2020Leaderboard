...
import com.mike.gads2020leaderboard.Adapter.SkilliqAdapter;
...
import static com.mike.gads2020leaderboard.Common.Common.URL_IQ;
...
public class SkilliqFragment extends Fragment {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try{
                            ...
                            for(int i=0;i<response.length();i++){
                                ...
                                leanermodel.setScore(leanersd.getInt("score"));
    ...
    private void setupRecycler(){
        skillAdapter = new SkilliqAdapter(getContext(),leaners);
